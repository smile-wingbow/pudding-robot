...
class Action(SerializationMixin, ContextMixin, BaseModel):
    ...
    # 增加对图片的支持
    async def _aask(self, prompt: str, system_msgs: Optional[list[str]] = None, images: Optional[Union[str, list[str]]] = None,) -> str:
        """Append default prefix"""
        return await self.llm.aask(prompt, system_msgs, images=images)
